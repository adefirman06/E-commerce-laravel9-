...
<body>
    ...
    <div class="hero_area">
        <!-- ?/header -->
        <span style="font-size: 17px; padding : 14px;">
            @include('home.header')
        </span>
        ...
        <div class="container">
            ...
            <h1 style="padding: 40px; margin: auto; text-align: center; font-size: 18px; padding: 50px;">Bayar Menggunakan Kartu Kredit Anda - Total Harga @currency($totalprice) </h1>
